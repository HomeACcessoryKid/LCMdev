...
- create/update the file versions1/latest-pre-release without new-line and setup 1.1.2 version folder
```
mkdir versions1/1.1.2v
echo -n 1.1.2 > versions1/1.1.2v/latest-pre-release
cp versions1/certs.sector* versions1/1.1.2v
cp versions1/public*key*   versions1/1.1.2v
```
- set local.mk to the ota-main program
```
make -j6 rebuild OTAVERSION=1.1.2
mv firmware/otamain.bin versions1/1.1.2v
```
- set local.mk back to ota-boot program
```
make -j6 rebuild OTAVERSION=1.1.2
mv firmware/otaboot.bin versions1/1.1.2v
make -j6 rebuild OTAVERSION=1.1.2 OTABETA=1
cp firmware/otaboot.bin versions1/1.1.2v/otabootbeta.bin
```
- remove the older version files
#
- commit this as version 1.1.2  
- set up a new github release 1.1.2 as a pre-release using the just commited master...  
...
```
make flash OTAVERSION=1.1.2 OTABETA=1
```
...
```
openssl sha384 versions1/1.1.2v/otamain.bin
xxd versions1/1.1.2v/otamain.bin.sig
```

- upload the file versions1/1.1.2v/latest-pre-release to the 'latest release' assets on github
...
```
cp  versions1/1.1.2v/public-1.key.sig versions1
```
...
```
cp  versions1/1.1.2v/certs.sector.sig versions1
```
