...
- create/update the file versions1/latest-pre-release without new-line and setup 1.2.3 version folder
```
mkdir versions1/1.2.3v
echo -n 1.2.3 > versions1/1.2.3v/latest-pre-release
cp versions1/certs.sector* versions1/1.2.3v
cp versions1/public*key*   versions1/1.2.3v
```
- set local.mk to the ota-main program
```
make -j6 rebuild OTAVERSION=1.2.3
mv firmware/otamain.bin versions1/1.2.3v
```
- set local.mk back to ota-boot program
```
make -j6 rebuild OTAVERSION=1.2.3
mv firmware/otaboot.bin versions1/1.2.3v
make -j6 rebuild OTAVERSION=1.2.3 OTABETA=1
cp firmware/otaboot.bin versions1/1.2.3v/otabootbeta.bin
```
- remove the older version files
#
- commit this as version 1.2.3  
- set up a new github release 1.2.3 as a pre-release using the just commited master...  
...
```
make flash OTAVERSION=1.2.3 OTABETA=1
```
...
```
openssl sha384 versions1/1.2.3v/otamain.bin
xxd versions1/1.2.3v/otamain.bin.sig
```

- upload the file versions1/1.2.3v/latest-pre-release to the 'latest release' assets on github
...
```
cp  versions1/1.2.3v/public-1.key.sig versions1
```
...
```
cp  versions1/1.2.3v/certs.sector.sig versions1
```
