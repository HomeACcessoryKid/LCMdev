...
- create/update the file versions1/latest-pre-release without new-line and setup 1.1.1 version folder
```
mkdir versions1/1.1.1v
echo -n 1.1.1 > versions1/1.1.1v/latest-pre-release
cp versions1/certs.sector* versions1/1.1.1v
cp versions1/public*key*   versions1/1.1.1v
```
- set local.mk to the ota-main program
```
make -j6 rebuild OTAVERSION=1.1.1
mv firmware/otamain.bin versions1/1.1.1v
```
- set local.mk back to ota-boot program
```
make -j6 rebuild OTAVERSION=1.1.1
mv firmware/otaboot.bin versions1/1.1.1v
make -j6 rebuild OTAVERSION=1.1.1 OTABETA=1
cp firmware/otaboot.bin versions1/1.1.1v/otabootbeta.bin
```
- remove the older version files
#
- commit this as version 1.1.1  
- set up a new github release 1.1.1 as a pre-release using the just commited master...  
...
```
make flash OTAVERSION=1.1.1 OTABETA=1
```
...
```
openssl sha384 versions1/1.1.1v/otamain.bin
xxd versions1/1.1.1v/otamain.bin.sig
```

- upload the file versions1/1.1.1v/latest-pre-release to the 'latest release' assets on github
...
```
cp  versions1/1.1.1v/public-1.key.sig versions1
```
...
```
cp  versions1/1.1.1v/certs.sector.sig versions1
```
